...
|-------|-------------|------------------|-------------|
| `group_cache` | 1 hour | 1,000 | Group metadata |
...
| `recent_messages` | 5 minutes | 1,000 | Recent messages for retry |
| `message_retry_counts` | 5 minutes | 5,000 | Retry count tracking |
