...
**Errors (`BotBuilderError`):**
- `MissingBackend` - No storage backend provided
- `MissingTransport` - No transport factory provided
- `MissingHttpClient` - No HTTP client provided
- `Other(anyhow::Error)` - Backend initialization or other failures
