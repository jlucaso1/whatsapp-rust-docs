...
The `Runtime` trait is the foundation of the runtime-agnostic architecture. It abstracts async task spawning, sleeping, and blocking operations. Implement it to use a different async runtime (e.g., async-std, smol, or a WASM executor).
