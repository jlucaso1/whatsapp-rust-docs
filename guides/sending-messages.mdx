...
description: Learn how to send text messages, reactions, quoted replies, album messages, sticker packs, and edit messages in whatsapp-rust
---
...
<Note>
Animated stickers are automatically detected from the WebP data. The `is_animated` field on each sticker proto entry is set based on whether the WebP file contains animation frames.
</Note>
