...
Access profile management operations for your own account.

**Methods:**
- `set_push_name(name: &str)` - Set your display name
- `set_status_text(text: &str)` - Set your about/status text
- `set_profile_picture(image_data: Vec<u8>)` - Set your profile picture
- `remove_profile_picture()` - Remove your profile picture
