...
- **Full media plane in Rust** - Mic/camera capture is the consumer's job; encode, encrypt, relay, decrypt, decode, and playout of the RTP/SRTP stream is all in Rust
