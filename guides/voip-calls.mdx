...
Add the `voip` feature to your `Cargo.toml`:

```toml
[dependencies]
whatsapp-rust = { version = "0.6", features = ["voip"] }
```

## Answering an Incoming Call

Listen for `Event::CallOffer`, then accept it with your audio source and sink:
