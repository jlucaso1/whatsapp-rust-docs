...
For direct access to the encryption primitive with constant memory usage (~40KB), use `encrypt_media_streaming`. This is the core function that `encrypt_media` wraps internally:
