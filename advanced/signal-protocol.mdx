...
Prewarming recovers roughly 90% and 82% of the gap between rebuilding cold and keeping the record warm; what's left is the correspondence check plus the caller-side cache lookup — real work a record that's never discarded doesn't pay.
