...
- [Chat Store](/api/chat-store#skipping-batches-your-durability-hook-already-committed) — avoid double-materializing a batch when a hook and `ChatStore` feed off the same event stream.
