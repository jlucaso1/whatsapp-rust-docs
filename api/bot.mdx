...
If you do not call this method, defaults apply (burst 20, refill 10/min). You can also retune it live after build via [`Client::set_resend_rate_limit`](/api/client#set_resend_rate_limit).
