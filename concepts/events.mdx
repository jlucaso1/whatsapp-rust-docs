...
- **`Hide`** — The application should silently discard the failure. Used for infrastructure messages (reactions, poll votes, pin changes, edit messages, event responses, and SKDM stanzas) that don't need user-visible placeholders.
