...
- **Full media plane in Rust** - Mic/camera capture and speaker/display playout are the consumer's job; encode, encrypt, relay, decrypt, and decode of the RTP/SRTP stream is all in Rust
