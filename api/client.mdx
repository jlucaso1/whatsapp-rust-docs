...
- Uploads a full batch of [`CacheConfig::wanted_pre_key_count`](/api/bot#pre-key-pool-sizing) pre-keys (default 812) with Fibonacci retry backoff (1s, 2s, 3s, 5s, 8s, ... capped at 610s)
