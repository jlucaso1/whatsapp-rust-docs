...
Para benchmarks de integração mais abrangentes, a suíte `bench-integration` mede cenários do mundo real (conectar, enviar, receber, reconectar) contra um servidor mock:
