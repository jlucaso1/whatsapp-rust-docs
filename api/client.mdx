...
| `reconnect()` / `reconnect_immediately()` | yes | immediately | the library's |
...
**What it guarantees:**
- Once this returns, the socket is closed and pending receipts and Signal state have been flushed on the same terms as `disconnect()`.
