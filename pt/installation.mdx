...
3. Habilita `-Zshare-generics=y` e recompila `std` com o perfil de release (`-Zbuild-std`) para participar do LTO gordo; juntos, reduzem o `.text` em ~15% em comparação com um `cargo build --release` simples
